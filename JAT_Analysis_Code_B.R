...
if (!dir.exists("output/plots_seguimiento")) {
  dir.create("output/plots_seguimiento", recursive = TRUE)
} else {
  message("output/plots_seguimiento already exists.")
}
...
df_contact <-
  df_jat %>%
  transmute(periodo = str_replace_all(periodo, "20(\\d{2})", "\\1")) %>%
...
ggsave(
  "output/plots_seguimiento/mentores_estatus_ocupacional.png",
  width = 8,
  height = 6
)
...
ggsave(
  "output/plots_seguimiento/mentores_estatus_ocupacional_sexo.png",
  width = 8,
  height = 6
)
...
ggsave(
  "output/plots_seguimiento/mentores_estatus_educativo.png",
  width = 8,
  height = 6
)
...
ggsave(
  "output/plots_seguimiento/mentores_estatus_educativo_sexo.png",
  width = 8,
  height = 6
)
